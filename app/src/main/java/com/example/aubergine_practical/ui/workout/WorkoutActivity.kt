...
import com.example.aubergine_practical.common.extentionviews.DATE_FORMAT_DD_MM_YYYY
import com.example.aubergine_practical.common.extentionviews.snack
import com.example.aubergine_practical.common.extentionviews.toFormatDate
import com.example.aubergine_practical.databinding.ActivityWorkoutBinding
...
class WorkoutActivity : BaseActivity<ActivityWorkoutBinding>() {
    ...
    override fun handleListener() {
         ...
         */
        mBinding.tvFilter.setOnClickListener { mFilterDateDialog.show() }
